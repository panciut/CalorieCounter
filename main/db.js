...
function initDb() {
  ...
  const migrations = [
    ...
    "ALTER TABLE log ADD COLUMN recipe_log_id TEXT",
    "ALTER TABLE log ADD COLUMN recipe_name TEXT",
    "CREATE INDEX IF NOT EXISTS idx_log_recipe_log_id ON log(recipe_log_id)",
