...
const ICONS: Record<PageName, string> = {
  ...
  plan:         'M9 11l3 3 8-8 M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11',
  suggestions:  'M9 21h6 M10 21v-3 M14 21v-3 M12 3a6 6 0 00-4 10.5V16h8v-2.5A6 6 0 0012 3z',
  ...
  stats:        'M3 3v18h18 M7 14l4-4 4 4 5-7',
...
const DEFAULT_ORDER: NavItem[] = [
  ...
  { page: 'plan',          labelKey: 'nav.plan',          group: 'plan' },
  { page: 'suggestions',   labelKey: 'nav.suggestions',   group: 'plan' },
  { page: 'week',          labelKey: 'nav.week',          group: 'plan' },
  { page: 'history',       labelKey: 'nav.history',       group: 'plan' },
  { page: 'stats',         labelKey: 'nav.stats',         group: 'plan' },
